...
// Retorne `ultimo`.
function ultimoElemento(carros){
 return carros[carros.length -1]
}
 let carros=["Maserati","Ferrari","Bugatti","Skyline"]
 console.log(ultimoElemento(carros))
...
function removeUltimo(flores){
    return flores.slice(0, flores.length -1)
}
let flores= ["girassol","rosa","margaridas","peonias"]
console.log(removeUltimo(flores))